...
if __name__ == "__main__":
    ...
    paper_reviewer_affinities = np.load("C:/Users/Ed Zaharof/Downloads/fair-matching-master/fair-matching-master/data/%s/scores.npy" % dataset)
    paper_capacities = np.load("C:/Users/Ed Zaharof/Downloads/fair-matching-master/fair-matching-master/data/%s/covs.npy" % dataset)
    ...
    fairflow_soln = load_fairflow_soln("C:/Users/Ed Zaharof/Downloads/ReviewerAssignmentCode-fair_flow_uai (1)/ReviewerAssignmentCode-fair_flow_uai/fair_matching_outputs/fair_matching_outputs/%s/fairflow/assignment.npy" % dataset)
    ...
    fairir_soln = load_fairflow_soln("C:/Users/Ed Zaharof/Downloads/ReviewerAssignmentCode-fair_flow_uai (1)/ReviewerAssignmentCode-fair_flow_uai/fair_matching_outputs/fair_matching_outputs/%s/fairir/assignment.npy" % dataset)
